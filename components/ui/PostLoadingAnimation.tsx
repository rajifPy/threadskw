...
export default function PostLoadingAnimation() {
  return (
        ...
        <div className="truck-body">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 198 93">
            ...
            <path 
              ...
              className="dark:fill-gray-400 dark:stroke-gray-400"
            />
            <rect 
              strokeWidth={2} 
              stroke="#282828" 
            ...
            <rect 
              ...
              y={84} 
              x={1} 
              className="dark:fill-gray-300 dark:stroke-gray-400"
            />
          </svg>
        </div>
    ...
    h78.747C231.693,100.736,232.77,106.162,232.77,111.694z" />
      ...
      <div className="mt-8 text-center loading-text">
